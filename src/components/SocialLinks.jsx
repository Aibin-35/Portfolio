...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/aibin-babu-8982a3328",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@aibin95",
    icon: Instagram,
    url: "https://www.instagram.com/aibin95?igsh=MWR6NWxkaTRlZnpjNA==",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@Aibin",
    icon: Youtube,
    url: "https://youtube.com/@aibinbabu-l2z?feature=shared",
    color: "#FF0000",
